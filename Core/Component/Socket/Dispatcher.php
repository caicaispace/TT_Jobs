...
class Dispatcher
{
    ...
    public function __construct($commandRegisterClass, $commandParserClass)
    {
    ...
    public static function getInstance($commandRegisterClass, $commandParserClass)
    {
    ...
    public function dispatchTCP($fd, $reactorId, $data)
    {
    ...
    public function dispatchUDP($data, $clientInfo)
    {
        $client = new UdpClient($clientInfo);
        $this->run($client, $data);
    }

    public function dispatchWEBSOCK(\swoole_websocket_frame $frame)
    {
