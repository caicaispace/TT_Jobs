...
{
    public const T_ELLIPSIS   = 1001;
    public const T_POW        = 1002;
    public const T_POW_EQUAL  = 1003;
    public const T_COALESCE   = 1004;
    public const T_SPACESHIP  = 1005;
    public const T_YIELD_FROM = 1006;

    public const PHP_7_0 = '7.0.0dev';
    public const PHP_5_6 = '5.6.0rc1';
